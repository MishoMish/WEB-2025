...
const translations = {
    bg: {
        ...
        sec6Sub9Title: "6.9. Дигитален маркетинг и SEO",
        sec6Sub9Para1: "ChatGPT може да подпомогне дигиталния маркетинг <a href='#ref-37'>[37]</a>:",
        sec6Sub9Li1: "<strong>Meta tags:</strong> Генериране на оптимизирани meta description, keywords",
        sec6Sub9Li2: "<strong>Structured data:</strong> Schema.org JSON-LD markup",
        sec6Sub9Li3: "<strong>Content optimization:</strong> Heading hierarchy, keyword density",
        sec6Sub9Li4: "<strong>Alt текстове:</strong> Accessibility и SEO описания на изображения",
    ...
    en: {
        ...
        sec6Sub9Title: "6.9. Digital Marketing and SEO",
        sec6Sub9Para1: "ChatGPT can assist with digital marketing <a href='#ref-37'>[37]</a>:",
        sec6Sub9Li1: "<strong>Meta tags:</strong> Generating optimized meta description, keywords",
        sec6Sub9Li2: "<strong>Structured data:</strong> Schema.org JSON-LD markup",
        sec6Sub9Li3: "<strong>Content optimization:</strong> Heading hierarchy, keyword density",
        sec6Sub9Li4: "<strong>Alt texts:</strong> Accessibility and SEO image descriptions",
