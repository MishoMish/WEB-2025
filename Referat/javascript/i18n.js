...
const translations = {
    bg: {
        ...
        // Figure captions
        figure1Caption: '<strong>Фигура 1.</strong> Еволюция на GPT моделите от GPT-1 до GPT-4 [8]',
        figure2Caption: '<strong>Фигура 2.</strong> Визуализация на Chain-of-Thought промптинг [18]',
        figure3Caption: '<strong>Фигура 3.</strong> Препоръчителна архитектура с backend proxy [27]',
        figure4Caption: '<strong>Фигура 4.</strong> Зависимост между точност и сложност на задачата [40]',
        
        // Prompt Engineering section
        promptTitle: '2. Prompt Engineering - Основни концепции',
        promptDefTitle: '2.1. Дефиниция и значение',
        promptDefText: 'Prompt Engineering е процесът на проектиране и оптимизация на входните данни (промптове), които се подават на езикови модели, за да се получат желаните резултати [11]. Ефективният промпт може драматично да подобри качеството на генерираните отговори, точността и релевантността на изхода [12].',
        ...
        technique1Text: 'Zero-shot prompting е базова техника, при която моделът получава задачата директно, без предварителни примери [13]. Това е най-простият подход, но изисква ясно и прецизно формулиране.',
        technique2Title: '2.2.2. Few-shot Prompting',
        technique2Text: 'Few-shot prompting включва предоставянето на няколко примера, които демонстрират желания формат или стил на отговор [15]. Това значително подобрява качеството на генерираните резултати, особено при специфични формати.',
        technique3Title: '2.2.3. Chain-of-Thought (CoT) Prompting',
        technique3Text: 'Chain-of-Thought е техника, при която се насърчава моделът да "мисли на глас" и да обяснява своята логика стъпка по стъпка [17]. Това е особено ефективно при сложни задачи по програмиране и дебъгване.',
        
        // Principles
        promptPrinciplesTitle: '2.3. Принципи за ефективни промпти',
        promptPrinciplesText: 'За създаването на ефективни промпти е необходимо да се спазват следните принципи [19][20]:',
        ...
        apiIntegrationText: 'OpenAI предоставя RESTful API, което позволява интеграция на ChatGPT във всяко уеб приложение [21]. API-то използва HTTP заявки и JSON формат за комуникация.',
        frontendIntegrationTitle: '3.2. Frontend интеграция',
        frontendIntegrationText: 'При frontend интеграцията е критично важно да се следват best practices за сигурност и производителност [23]. Никога не трябва да се излага API ключа директно в клиентския код.',
        backendIntegrationTitle: '3.3. Backend интеграция (Node.js/Express)',
        backendIntegrationText: 'Backend сървърът действа като посредник между клиента и OpenAI API, осигурявайки сигурност и контрол [25].',
        ...
        // Code captions
        code1Caption: '<strong>Код 1.</strong> Zero-shot промпт за генериране на HTML форма [14]',
        code2Caption: '<strong>Код 2.</strong> Few-shot промпт за CSS генериране [16]',
        code3Caption: '<strong>Код 3.</strong> Базова настройка на OpenAI API клиент [22]',
        code4Caption: '<strong>Код 4.</strong> Frontend чат интерфейс със защита срещу XSS [24]',
        code5Caption: '<strong>Код 5.</strong> Express backend с rate limiting и валидация [26]',
        code6Caption: '<strong>Код 6.</strong> Промпт за генериране на React компонент [29]',
        code7Caption: '<strong>Код 7.</strong> Debugging промпт с примерно решение [31]',
        code8Caption: '<strong>Код 8.</strong> Автоматично генерирана JSDoc документация [33]',
        code9Caption: '<strong>Код 9.</strong> Защита от prompt injection атаки [36]',
        
        // Examples
        examplesTitle: '4. Практически примери',
        exampleCodeGenTitle: '4.1. Генериране на код',
        exampleCodeGenText: 'ChatGPT може ефективно да генерира уеб код базиран на естествени описания [28]. Важно е промптът да съдържа специфични изисквания за технологии, стил и функционалност.',
        exampleDebugTitle: '4.2. Debugging и оптимизация',
        exampleDebugText: 'ChatGPT може да помогне при откриване и поправяне на грешки в кода [30]. Ефективният debugging промпт трябва да включва: проблемното поведение, очакваното поведение и релевантния код.',
        exampleDocTitle: '4.3. Генериране на документация',
        exampleDocText: 'Автоматичното генериране на документация е една от най-полезните приложения на ChatGPT [32]. Моделът може да анализира код и да създаде професионална документация.',
        
        // Best Practices
        bestPracticesTitle: '5. Добри практики и предизвикателства',
        securityTitle: '5.1. Сигурност',
        securityText: 'При интеграция на ChatGPT в production среда, сигурността е критичен фактор [34][35]:',
        ...
        performanceText: 'Оптимизацията на производителността и контролът на разходите са ключови за устойчиви приложения [37]:',
        modelName: 'Модел',
        modelSpeed: 'Скорост',
        ...
        limitationsText: 'Важно е да се разбират ограниченията на технологията [38][39]:',
        ...
        futureText: 'Технологията на LLM моделите продължава да се развива бързо [41][42]:',
        ...
        conclusionText1: 'Prompt Engineering и интеграцията на ChatGPT в уеб приложения представляват значителна промяна в начина, по който разработваме софтуер [43]. Технологията предлага безпрецедентни възможности за автоматизация, подобряване на производителността и създаване на интелигентни приложения.',
        conclusionText2: 'Успешната имплементация изисква задълбочено разбиране на принципите на Prompt Engineering, правилна архитектура на приложението и постоянно внимание към сигурността и оптимизацията [44]. Разработчиците трябва да балансират между иновацията и отговорността, като използват тази мощна технология етично и ефективно.',
        conclusionText3: 'С развитието на технологията, очакваме да видим още по-силна интеграция между AI асистенти и уеб разработката, което ще доведе до нови парадигми в създаването на дигитални продукти [45]. Ключът към успеха е непрекъснатото обучение и адаптиране към новите възможности, които тази технология предлага.',
    ...
    en: {
        ...
        abstractText: 'This paper presents an in-depth analysis of the interaction between Prompt Engineering techniques and modern web development using ChatGPT. It examines the core principles of creating effective prompts, integrating the ChatGPT API into web applications, and practical examples for development automation. Special attention is given to architectural decisions, security, and optimization when working with language models [1][2][3].',
        
        // Introduction
        introTitle: '1. Introduction',
        introWhatIsTitle: '1.1. What is ChatGPT',
        introWhatIsText: 'ChatGPT is a Large Language Model (LLM) developed by OpenAI, based on the GPT (Generative Pre-trained Transformer) architecture [4]. The model is trained on vast amounts of text data and can generate human-like text, answer questions, write code, and assist with various tasks [5].',
        introHistoryText: 'The first version of GPT was released in 2018, with each subsequent iteration significantly improving the model\'s capabilities. GPT-3, released in 2020, contains 175 billion parameters and represents a revolution in natural language processing [6]. ChatGPT, based on GPT-3.5 and GPT-4, adds conversational interaction capabilities and is optimized through Reinforcement Learning from Human Feedback (RLHF) [7].',
        introWebDevTitle: '1.2. Significance for Web Development',
        introWebDevText: 'Integrating ChatGPT into web development opens new possibilities for [9][10]:',
        ...
        // Figure captions
        figure1Caption: '<strong>Figure 1.</strong> Evolution of GPT models from GPT-1 to GPT-4 [8]',
        figure2Caption: '<strong>Figure 2.</strong> Chain-of-Thought prompting visualization [18]',
        figure3Caption: '<strong>Figure 3.</strong> Recommended architecture with backend proxy [27]',
        figure4Caption: '<strong>Figure 4.</strong> Relationship between accuracy and task complexity [40]',
        
        // Prompt Engineering section
        promptTitle: '2. Prompt Engineering - Core Concepts',
        promptDefTitle: '2.1. Definition and Significance',
        promptDefText: 'Prompt Engineering is the process of designing and optimizing input data (prompts) that are fed to language models to obtain desired results [11]. An effective prompt can dramatically improve the quality of generated responses, accuracy, and relevance of output [12].',
        ...
        technique1Title: '2.2.1. Zero-shot Prompting',
        technique1Text: 'Zero-shot prompting is a basic technique where the model receives the task directly, without prior examples [13]. This is the simplest approach but requires clear and precise formulation.',
        technique2Title: '2.2.2. Few-shot Prompting',
        technique2Text: 'Few-shot prompting involves providing several examples that demonstrate the desired format or response style [15]. This significantly improves the quality of generated results, especially for specific formats.',
        technique3Title: '2.2.3. Chain-of-Thought (CoT) Prompting',
        technique3Text: 'Chain-of-Thought is a technique that encourages the model to "think aloud" and explain its logic step by step [17]. This is particularly effective for complex programming and debugging tasks.',
        
        // Principles
        promptPrinciplesTitle: '2.3. Principles for Effective Prompts',
        promptPrinciplesText: 'Creating effective prompts requires following these principles [19][20]:',
        ...
        apiIntegrationText: 'OpenAI provides a RESTful API that enables ChatGPT integration into any web application [21]. The API uses HTTP requests and JSON format for communication.',
        frontendIntegrationTitle: '3.2. Frontend Integration',
        frontendIntegrationText: 'For frontend integration, it is critical to follow best practices for security and performance [23]. API keys should never be exposed in client-side code.',
        backendIntegrationTitle: '3.3. Backend Integration (Node.js/Express)',
        backendIntegrationText: 'The backend server acts as a mediator between the client and OpenAI API, ensuring security and control [25].',
        ...
        // Code captions
        code1Caption: '<strong>Code 1.</strong> Zero-shot prompt for HTML form generation [14]',
        code2Caption: '<strong>Code 2.</strong> Few-shot prompt for CSS generation [16]',
        code3Caption: '<strong>Code 3.</strong> Basic OpenAI API client setup [22]',
        code4Caption: '<strong>Code 4.</strong> Frontend chat interface with XSS protection [24]',
        code5Caption: '<strong>Code 5.</strong> Express backend with rate limiting and validation [26]',
        code6Caption: '<strong>Code 6.</strong> Prompt for React component generation [29]',
        code7Caption: '<strong>Code 7.</strong> Debugging prompt with sample solution [31]',
        code8Caption: '<strong>Code 8.</strong> Auto-generated JSDoc documentation [33]',
        code9Caption: '<strong>Code 9.</strong> Protection against prompt injection attacks [36]',
        
        // Examples
        examplesTitle: '4. Practical Examples',
        exampleCodeGenTitle: '4.1. Code Generation',
        exampleCodeGenText: 'ChatGPT can effectively generate web code based on natural descriptions [28]. It is important that the prompt contains specific requirements for technologies, style, and functionality.',
        exampleDebugTitle: '4.2. Debugging and Optimization',
        exampleDebugText: 'ChatGPT can help identify and fix errors in code [30]. An effective debugging prompt should include: problematic behavior, expected behavior, and relevant code.',
        exampleDocTitle: '4.3. Documentation Generation',
        exampleDocText: 'Automatic documentation generation is one of the most useful applications of ChatGPT [32]. The model can analyze code and create professional documentation.',
        
        // Best Practices
        bestPracticesTitle: '5. Best Practices and Challenges',
        securityTitle: '5.1. Security',
        securityText: 'When integrating ChatGPT in a production environment, security is a critical factor [34][35]:',
        ...
        performanceText: 'Performance optimization and cost control are key to sustainable applications [37]:',
        modelName: 'Model',
        modelSpeed: 'Speed',
        ...
        limitationsText: 'It is important to understand the technology\'s limitations [38][39]:',
        ...
        futureText: 'LLM model technology continues to develop rapidly [41][42]:',
        ...
        conclusionText1: 'Prompt Engineering and ChatGPT integration in web applications represent a significant shift in how we develop software [43]. The technology offers unprecedented opportunities for automation, productivity improvement, and creating intelligent applications.',
        conclusionText2: 'Successful implementation requires deep understanding of Prompt Engineering principles, proper application architecture, and constant attention to security and optimization [44]. Developers must balance innovation and responsibility, using this powerful technology ethically and effectively.',
        conclusionText3: 'With the development of technology, we expect to see even stronger integration between AI assistants and web development, leading to new paradigms in creating digital products [45]. The key to success is continuous learning and adapting to the new possibilities this technology offers.',
