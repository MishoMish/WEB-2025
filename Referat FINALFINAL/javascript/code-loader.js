...
const codeExamples = {
    'code-1': {
        file: 'code-examples/code-1-zero-shot.js',
        language: 'javascript'
    },
    'code-2': {
        file: 'code-examples/code-2-few-shot.js',
        language: 'javascript'
    },
    'code-3': {
        file: 'code-examples/code-3-api-setup.js',
        language: 'javascript'
    },
    'code-4': {
        file: 'code-examples/code-4-frontend-chat.html',
        language: 'html'
    },
    'code-5': {
        file: 'code-examples/code-5-backend-express.js',
        language: 'javascript'
    },
    'code-6': {
        file: 'code-examples/code-6-react-component.js',
        language: 'javascript'
    },
    'code-7': {
        file: 'code-examples/code-7-debugging.js',
        language: 'javascript'
    },
    'code-8': {
        file: 'code-examples/code-8-jsdoc.js',
        language: 'javascript'
    },
    'code-9': {
        file: 'code-examples/code-9-security.js',
        language: 'javascript'
    }
};
