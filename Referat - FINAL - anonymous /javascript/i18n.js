...
const translations = {
  bg: {
    ...
    sec1Sub1Li1:
      "<strong>AI бум:</strong> Според проучване на McKinsey от 2023 г., над 50% от организациите вече използват AI инструменти в поне една бизнес функция <a href='#ref-5'>[5]</a>.",
    sec1Sub1Li2:
      "<strong>Нужда от скорост:</strong> Съвременните разработвателни цикли изискват все по-бързо доставяне на функционалности, където AI може да ускори разработката с до 40% <a href='#ref-6'>[6]</a>.",
    sec1Sub1Li3:
      "<strong>Промяна в работните процеси:</strong> Появата на \"AI-assisted development\" променя фундаментално начина, по който се пише, тества и поддържа код <a href='#ref-7'>[7]</a>.",
    ...
    sec2Para1:
      "Prompt engineering е процесът на проектиране и оптимизация на инструкции (промптове) към AI модели, за да се постигнат точни, релевантни и полезни резултати <a href='#ref-8'>[8]</a>. Терминът произлиза от естествено-езиковото взаимодействие с LLM модели като GPT-4, Claude, LLaMA и други <a href='#ref-9'>[9]</a>.",

    sec2Sub1Title: "2.1. Дефиниция и основни концепции",
    sec2Sub1Para1:
      "Според OpenAI, prompt engineering включва \"систематичното създаване на ефективни промпт формулировки, които максимизират качеството и релевантността на отговорите на AI моделите\" <a href='#ref-10'>[10]</a>. Това включва:",
    sec2Sub1Li1: "<strong>Ясност:</strong> Прецизно формулиране на задачата",
    sec2Sub1Li2:
      "<strong>Контекст:</strong> Предоставяне на необходима информация",
    ...
    sec2Sub2Para1:
      "LLM моделите функционират на принципа на статистическо предсказване на следващия токен в последователност <a href='#ref-11'>[11]</a>. Качеството на промпта директно влияе върху:",
    sec2Sub2Li1:
      "<strong>Точност:</strong> Колко добре моделът разбира задачата",
    sec2Sub2Li2:
      "<strong>Релевантност:</strong> Доколко отговорът отговаря на нуждите",
    sec2Sub2Li3:
      "<strong>Консистентност:</strong> Стабилност при повторни заявки",
    sec2Sub2Li4:
      "<strong>Ефективност:</strong> Време и ресурси за получаване на резултат",
    sec2Sub2Para2:
      "Фигура 1 илюстрира основния поток на взаимодействие между потребител, промпт и LLM модел.",

    figure1Caption:
      "<strong>Фигура 1.</strong> Поток на взаимодействие при prompt engineering",

    // Section 3: Techniques
    sec3Title: "3. Основни техники и подходи в Prompt Engineering",
    sec3Para1:
      "Съществуват множество техники за оптимизация на промптове, всяка с различни приложения и предимства <a href='#ref-12'>[12]</a>. В тази секция ще разгледаме най-важните от тях.",

    sec3Sub1Title: "3.1. Поставяне на роля и контекст",
    sec3Sub1Para1:
      "Една от най-основните техники е задаването на роля и контекст на AI модела <a href='#ref-13'>[13]</a>. Това се постига чрез инструкции като показаните в Код 1.",
    code1Caption: "Код 1: Базов prompt за генериране на HTML форма",
    sec3Sub1Para2:
      "Тази техника помага на модела да \"влезе в ролята\" и да генерира по-релевантен отговор <a href='#ref-14'>[14]</a>.",

    sec3Sub2Title: "3.2. Ограничения, формати и изходни структури",
    sec3Sub2Para1:
      "Спецификацията на точен формат и ограничения е критична за получаване на използваем резултат <a href='#ref-15'>[15]</a>. Виж Код 2 за пример:",
    code2Caption: "Код 2: Advanced prompt с контекст и ограничения",

    sec3Sub3Title: "3.3. Итеративни промптове и рефайнмент",
    sec3Sub3Para1:
      "Рядко първият промпт дава перфектен резултат. Итеративният подход включва постепенно уточняване <a href='#ref-16'>[16]</a>:",
    ...
    sec3Sub4Para1:
      "Few-shot learning предоставя на модела примери за желания формат и стил <a href='#ref-17'>[17]</a>. Виж Код 3:",
    code3Caption: "Код 3: Few-shot prompt с примери",

    sec3Sub5Title: "3.5. Chain-of-thought (CoT)",
    sec3Sub5Para1:
      "Chain-of-thought промптването насърчава модела да \"мисли на глас\" и да показва стъпките в разсъжденията си <a href='#ref-18'>[18]</a>. Това е особено полезно за сложни задачи. Виж Код 4:",
    code4Caption: "Код 4: Chain-of-thought prompt за решаване на проблем",
    sec3Sub5Para2:
      "Важна етична бележка: При използване на CoT, трябва да сме наясно, че моделът симулира разсъждения, но не \"мисли\" по човешки начин <a href='#ref-19'>[19]</a>. Резултатите винаги трябва да се валидират.",

    sec3Sub6Title: "3.6. Self-consistency и Toolformer-стил",
    sec3Sub6Para1:
      "Self-consistency включва генериране на множество отговори и избор на най-консистентния <a href='#ref-20'>[20]</a>. Toolformer-стил взаимодействие позволява на AI да \"извиква\" външни инструменти <a href='#ref-21'>[21]</a>:",
    ...
    sec3Sub7Para1:
      "Критично важна е систематичната проверка на AI генерирания код <a href='#ref-22'>[22]</a>:",
    sec3Sub7Para2:
    ...
    sec4Para1:
      "ChatGPT и подобни LLM модели предлагат широк спектър от приложения в уеб разработката, от генериране на boilerplate код до помощ при архитектурни решения <a href='#ref-23'>[23]</a>.",

    sec4Sub1Title: "4.1. Генериране на HTML/CSS/JS шаблони",
    sec4Sub1Para1:
      "Едно от най-практичните приложения е автоматичното генериране на код шаблони <a href='#ref-24'>[24]</a>. Виж Код 5:",
    code5Caption: "Код 5: Базов HTML5 шаблон с семантична структура",

    sec4Sub2Title: "4.2. CSS генериране и layout системи",
    sec4Sub2Para1:
      "AI моделите могат ефективно да генерират модерни CSS layout-и <a href='#ref-25'>[25]</a>. Код 6 демонстрира CSS Grid система:",
    code6Caption: "Код 6: CSS Grid layout генериран от AI",

    sec4Sub3Title: "4.3. JavaScript и DOM манипулация",
    sec4Sub3Para1:
      "ChatGPT може да генерира функционален JavaScript код <a href='#ref-26'>[26]</a>. Виж Код 7:",
    code7Caption: "Код 7: JavaScript функция за DOM манипулация",

    sec4Sub4Title: "4.4. Архитектура, документация и тестове",
    sec4Sub4Para1:
      "AI може да помогне при проектиране на архитектура и генериране на документация <a href='#ref-27'>[27]</a>:",
    sec4Sub4Li1:
      "<strong>Architecture diagrams:</strong> Генериране на PlantUML, Mermaid диаграми",
    sec4Sub4Li2:
      "<strong>API документация:</strong> OpenAPI/Swagger спецификации",
    sec4Sub4Li3:
      "<strong>README файлове:</strong> Структурирана проектна документация",
    sec4Sub4Li4: "<strong>Unit tests:</strong> Jest, Mocha, Pytest тест казуси",

    sec4Sub5Title: "4.5. i18n и локализация",
    sec4Sub5Para1:
      "ChatGPT може да генерира структури за интернационализация <a href='#ref-28'>[28]</a>. Код 8 показва пример:",
    code8Caption: "Код 8: Пример за i18n структура",

    sec4Sub6Title: "4.6. Добри практики за интеграция в pipeline",
    sec4Sub6Para1:
      "Интегрирането на AI в разработвателския процес изисква дисциплина <a href='#ref-29'>[29]</a>:",
    ...
    figure2Caption:
      '<strong>Фигура 2.</strong> Визуализация на рисковете при "blind AI-coding"',
    sec4Sub7Para1:
      "Фигура 2 илюстрира опасностите от некритично приемане на AI генериран код. Основните рискове включват <a href='#ref-30'>[30]</a>:",
    sec4Sub7Li1:
      "<strong>Грешки:</strong> AI може да генерира синтактично верен, но логически грешен код",
    sec4Sub7Li2:
      "<strong>Неоптималност:</strong> Моделите не винаги генерират най-ефективното решение",
    sec4Sub7Li3:
      "<strong>Липса на стандарти:</strong> AI може да не следва проектните конвенции",
    sec4Sub7Li4:
      "<strong>Security:</strong> Уязвимости като XSS, SQL injection, CSRF <a href='#ref-31'>[31]</a>",
    sec4Sub7Para2:
      "Особено опасен е феноменът \"vibe coding\" - когато разработчици слепо копират AI генериран код без да разбират как работи <a href='#ref-32'>[32]</a>.",

    sec4Sub8Title: "4.8. Етика и професионална отговорност",
    sec4Sub8Para1:
      "Използването на AI в разработката поражда етични въпроси <a href='#ref-33'>[33]</a>:",

    sec4Sub8Sub1Title: "Халюцинации",
    sec4Sub8Sub1Para1:
      "AI моделите могат да \"измислят\" факти, API-та или библиотеки, които не съществуват <a href='#ref-34'>[34]</a>. Примери:",
    ...
    sec4Sub8Sub2Para1:
      "Всяка AI препоръка трябва да се валидира срещу официална документация <a href='#ref-35'>[35]</a>:",
    ...
    sec4Sub8Sub3Para1:
      "Сложни въпроси за интелектуална собственост <a href='#ref-36'>[36]</a>:",
    ...
    sec4Sub9Para1:
      "ChatGPT може да подпомогне дигиталния маркетинг <a href='#ref-37'>[37]</a>:",
    sec4Sub9Li1:
      "<strong>Meta tags:</strong> Генериране на оптимизирани meta description, keywords",
    sec4Sub9Li2: "<strong>Structured data:</strong> Schema.org JSON-LD markup",
    sec4Sub9Li3:
      "<strong>Content optimization:</strong> Heading hierarchy, keyword density",
    sec4Sub9Li4:
      "<strong>Alt текстове:</strong> Accessibility и SEO описания на изображения",
    code9Caption: "Код 9: Пример за meta tags оптимизация",

    sec4Sub10Title: "4.10. Бъдещето на професиите",
    sec4Sub10Para1:
      "AI променя фундаментално професията на уеб разработчика <a href='#ref-38'>[38]</a>:",
    ...
    sec4Sub10Sub3Para1:
      "Предизвикателства за начинаещи <a href='#ref-40'>[40]</a>:",
    ...
    sec4Sub10Sub4Para1:
      "Трансформация на процесите <a href='#ref-41'>[41]</a>:",
    ...
    sec5Sub3Case1Para:
      "Разработчик използва ChatGPT за генериране на responsive navigation menu. AI генерира чист код с accessibility features. След малки корекции, кодът е production-ready <a href='#ref-42'>[42]</a>.",

    sec5Sub3Case2Title: "Случай 2: Проблематично използване",
    sec5Sub3Case2Para:
      "Junior разработчик поиска от AI да генерира authentication система. AI създаде код без proper password hashing и с SQL injection уязвимости. Само след security audit проблемите са открити <a href='#ref-43'>[43]</a>.",
    ...
    sec5Sub3Case3Result:
      "Резултат: 35% по-бърза разработка при запазване на качеството <a href='#ref-44'>[44]</a>.",

    sec5Sub4Title: "5.4. Как да валидираме резултата",
    sec5Sub4Para1:
      "Систематичен подход за валидация <a href='#ref-45'>[45]</a>:",
    ...
    sec6Para1:
      "Въпреки предимствата, използването на AI в уеб разработката носи значителни рискове, които изискват внимание и митигация <a href='#ref-46'>[46]</a>.",

    sec6Sub1Title: "6.1. Етически предизвикателства",

    sec6Sub1Sub1Title: "Прозрачност",
    sec6Sub1Sub1Para1:
      "Трябва ли да се декларира, че код е AI-генериран? <a href='#ref-47'>[47]</a>",
    ...
    sec6Sub1Sub2Para1:
      "AI моделите могат да възпроизведат предразсъдъци от тренировъчните данни <a href='#ref-48'>[48]</a>:",
    ...
    sec6Sub2Para1:
      "Статистика показва, че GPT-4 може да генерира невалиден код в 12-18% от случаите <a href='#ref-49'>[49]</a>. Типични проблеми:",
    ...
    sec6Sub3Para1:
      "AI генерираният код може да съдържа уязвимости <a href='#ref-50'>[50]</a>:",
    sec6Sub3Li1: "<strong>XSS:</strong> Недостатъчна input санитизация",
    sec6Sub3Li2:
      "<strong>SQL Injection:</strong> Директно вмъкване на user input",
    ...
    sec6Sub4Para1:
      "AI може да генерира невалидни или измислени цитати <a href='#ref-51'>[51]</a>:",
    ...
    sec6Sub4Para2:
      "<strong>Решение:</strong> Винаги проверявайте цитатите в оригиналния източник!",

    sec6Sub5Title: "6.5. Критични контролни точки",
    sec6Sub5Para1:
      "Задължителни проверки при използване на AI код <a href='#ref-52'>[52]</a>:",
    ...
    sec6Sub5Li7:
      "<strong>Production monitoring:</strong> Error tracking, analytics",

    // Section 7: Conclusion
    sec7Title: "7. Заключение",
    sec7Para1:
      "Prompt engineering представлява мощен инструмент за модерната уеб разработка, който може значително да ускори и подобри процеса на създаване на софтуер <a href='#ref-53'>[53]</a>. Въпреки това, технологията изисква отговорен и критичен подход.",

    sec7Sub1Title: "7.1. Авторско мнение",
    sec7Sub1Para1:
      "Въз основа на изследването в този реферат, считам, че ChatGPT и prompt engineering <strong>трябва да се използват</strong>, но при следните условия:",
    ...
    sec7Sub2Para1:
      "Препоръки за отговорно използване <a href='#ref-54'>[54]</a>:",
    ...
    sec7Sub2Li3:
      "<strong>Education:</strong> Обучавайте се на основите преди да използвате AI",
    sec7Sub2Li4: "<strong>Testing:</strong> Comprehensive test coverage",
    sec7Sub2Li5: "<strong>Security:</strong> Regular security audits",
    sec7Sub2Li6:
      "<strong>Ethics:</strong> Съобразявайте се с етичните стандарти",
    sec7Sub2Li7:
      "<strong>Continuous learning:</strong> AI еволюира, адаптирайте се",

    sec7Sub3Title: "7.3. Бъдещи перспективи",
    sec7Sub3Para1:
      "В следващите 5-10 години очаквам <a href='#ref-55'>[55]</a>:",
    sec7Sub3Li1:
      "<strong>Специализирани модели:</strong> AI обучени конкретно за web frameworks",
    sec7Sub3Li2:
      "<strong>IDE интеграция:</strong> Seamless AI assistance в dev tools",
    sec7Sub3Li3:
      "<strong>Автоматизация:</strong> End-to-end код генериране от design",
    sec7Sub3Li4:
      "<strong>Нови роли:</strong> AI prompt engineers, AI code reviewers",
    sec7Sub3Li5:
      "<strong>Стандарти:</strong> Industry guidelines за AI използване",

    sec7Sub4Title: "7.4. Финални думи",
    sec7Sub4Para1:
      "Prompt engineering не е магическо решение, а инструмент, който изисква умение, критично мислене и професионална отговорност. Успешните разработчици ще бъдат тези, които комбинират фундаментални знания с ефективно използване на AI технологии <a href='#ref-56'>[56]</a>.",
    sec7Sub4Para2:
    ...
    ref10:
      "[10] OpenAI, \"Best Practices for Prompt Engineering\", OpenAI Documentation, [<a href='https://platform.openai.com/docs/guides/prompt-engineering' target='_blank'>https://platform.openai.com/docs/guides/prompt-engineering</a>].",
    ref11:
      '[11] Vaswani, A., et al., "Attention Is All You Need", published 2017, NeurIPS 2017.',
    ref12:
      '[12] Zhou, Y., et al., "Large Language Models Are Human-Level Prompt Engineers", published 2023, ICLR 2023.',
    ref13:
      '[13] Shanahan, M., et al., "Role-Play with Large Language Models", published October 2023, Nature Machine Intelligence.',
    ref14:
      '[14] Kojima, T., et al., "Large Language Models are Zero-Shot Reasoners", published 2022, NeurIPS 2022.',
    ref15:
      '[15] Dettmers, T., et al., "GPT3.int8(): 8-bit Matrix Multiplication for Transformers at Scale", published 2022, NeurIPS 2022.',
    ref16:
      '[16] Madaan, A., et al., "Self-Refine: Iterative Refinement with Self-Feedback", published March 2023, arXiv preprint.',
    ref17:
      '[17] Dong, Q., et al., "A Survey on In-context Learning", published December 2022, arXiv preprint.',
    ref18:
      '[18] Wei, J., et al., "Chain-of-Thought Prompting Elicits Reasoning in Large Language Models", published 2022, NeurIPS 2022.',
    ref19:
      '[19] Mitchell, M., "Why AI is Harder Than We Think", published April 2021, arXiv preprint.',
    ref20:
      '[20] Wang, X., et al., "Self-Consistency Improves Chain of Thought Reasoning in Language Models", published 2023, ICLR 2023.',
    ref21:
      '[21] Schick, T., et al., "Toolformer: Language Models Can Teach Themselves to Use Tools", published February 2023, arXiv preprint.',
    ref22:
      '[22] Chen, M., et al., "Evaluating Large Language Models Trained on Code", published July 2021, arXiv preprint.',
    ref23:
      '[23] Jiang, E., et al., "Promptmaker: Prompt-based Prototyping with Large Language Models", published 2022, CHI 2022.',
    ref24:
      '[24] Dakhel, A., et al., "GitHub Copilot AI pair programmer: Asset or Liability?", published September 2023, Journal of Systems and Software, vol. 203.',
    ref25:
      "[25] MDN Web Docs, \"CSS Grid Layout\", Mozilla Developer Network, [<a href='https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Grid_Layout' target='_blank'>MDN</a>].",
    ref26:
      '[26] MDN Web Docs, "Manipulating Documents", Mozilla Developer Network.',
    ref27:
      '[27] Pressman, R., Maxim, B., "Software Engineering: A Practitioner\'s Approach", published 2020, 9th Edition, McGraw-Hill Education.',
    ref28:
      '[28] W3C, "Internationalization Best Practices", W3C Working Draft.',
    ref29:
    ...
    ref30:
      '[30] Perry, N., et al., "Do Users Write More Insecure Code with AI Assistants?", published August 2023, arXiv preprint.',
    ref31: '[31] OWASP, "OWASP Top Ten 2021", OWASP Foundation.',
    ref32:
      '[32] Barke, S., et al., "Grounded Copilot: How Programmers Interact with Code-Generating Models", published 2023, OOPSLA 2023.',
    ref33:
      '[33] Bender, E., et al., "On the Dangers of Stochastic Parrots: Can Language Models Be Too Big?", published 2021, FAccT 2021.',
    ref34:
      '[34] Ji, Z., et al., "Survey of Hallucination in Natural Language Generation", published March 2023, ACM Computing Surveys, vol. 55, no. 12.',
    ref35:
      '[35] MDN Web Docs, "HTML: HyperText Markup Language", Mozilla Developer Network.',
    ref36:
    ...
    ref37:
      '[37] Search Engine Journal, "AI for SEO: Complete Guide", published October 2023.',
    ref38:
      '[38] World Economic Forum, "The Future of Jobs Report 2023", published April 2023, WEF.',
    ref39:
      '[39] ACM, "Computing Curricula 2020", published December 2020, ACM/IEEE Computer Society.',
    ref40:
    ...
    ref42:
      '[42] Stack Overflow, "2023 Developer Survey", published May 2023, Stack Overflow.',
    ref43:
      '[43] Nguyen, N., Nadi, S., "An Empirical Evaluation of GitHub Copilot\'s Code Suggestions", published 2022, MSR 2022.',
    ref44:
      '[44] Ross, S., et al., "Programmer Experiences with GitHub Copilot", published August 2023, arXiv preprint.',
    ...
    ref49:
      '[49] Borji, A., "A Categorical Archive of ChatGPT Failures", published February 2023, arXiv preprint.',
    ref50:
    ...
    ref53:
      '[53] Radford, A., et al., "Language Models are Unsupervised Multitask Learners", published 2019, OpenAI Blog.',
    ref54: '[54] IEEE, "IEEE Code of Ethics", IEEE.',
    ref55:
      '[55] Brynjolfsson, E., et al., "Generative AI at Work", published April 2023, NBER Working Paper.',
    ref56:
      '[56] Hutson, M., "Could AI help you to write better code?", published April 2023, Nature, vol. 616.',

    // Footer
    footerText:
      '&copy; 2025 Факултет по математика и информатика, СУ "Св. Климент Охридски"',
    footerCourse:
      "Курс по Уеб технологии, 25 издание (зимен семестър 2025-2026)",
    footerAuthor:
      "Студент ФМИ • Фак. номер • <a href='https://github.com' target='_blank' rel='noopener noreferrer' class='github-link'><svg width='20' height='20' viewBox='0 0 16 16' fill='currentColor' style='vertical-align: middle; margin-right: 4px'><path d='M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z'/></svg>GitHub</a>",
  },
  ...
  en: {
    ...
    abstractText:
      "In the modern era of artificial intelligence, prompt engineering emerges as a key competency for effective interaction with AI systems. This paper explores the application of prompt engineering in the context of web development with ChatGPT. It examines core techniques (Few-shot learning, Chain-of-Thought, Role-based prompting), practical applications for generating HTML/CSS/JavaScript code, as well as risks and ethical challenges. Issues of security, reliability, and professional responsibility when using AI-generated code are analyzed. The research emphasizes the need for a balanced approach that combines AI capabilities with critical thinking and fundamental knowledge in web development.",
    ...
    sec1Sub1Para1:
      "Several factors determine the relevance of prompt engineering in web development:",
    sec1Sub1Li1:
      "<strong>AI Boom:</strong> According to a 2023 McKinsey study, over 50% of organizations already use AI tools in at least one business function <a href='#ref-5'>[5]</a>.",
    sec1Sub1Li2:
      "<strong>Need for Speed:</strong> Modern development cycles require increasingly faster delivery of features, where AI can accelerate development by up to 40% <a href='#ref-6'>[6]</a>.",
    sec1Sub1Li3:
      "<strong>Workflow Changes:</strong> The emergence of \"AI-assisted development\" fundamentally changes how code is written, tested, and maintained <a href='#ref-7'>[7]</a>.",
    ...
    sec2Para1:
      "Prompt engineering is the process of designing and optimizing instructions (prompts) to AI models to achieve accurate, relevant, and useful results <a href='#ref-8'>[8]</a>. The term derives from natural language interaction with LLM models such as GPT-4, Claude, LLaMA, and others <a href='#ref-9'>[9]</a>.",

    sec2Sub1Title: "2.1. Definition and Core Concepts",
    sec2Sub1Para1:
      "According to OpenAI, prompt engineering includes \"the systematic creation of effective prompt formulations that maximize the quality and relevance of AI model responses\" <a href='#ref-10'>[10]</a>. This includes:",
    ...
    sec2Sub2Para1:
      "LLM models function on the principle of statistical prediction of the next token in a sequence <a href='#ref-11'>[11]</a>. The quality of the prompt directly affects:",
    sec2Sub2Li1:
      "<strong>Accuracy:</strong> How well the model understands the task",
    sec2Sub2Li2:
      "<strong>Relevance:</strong> How much the response meets needs",
    sec2Sub2Li3:
      "<strong>Consistency:</strong> Stability across repeated queries",
    sec2Sub2Li4:
      "<strong>Efficiency:</strong> Time and resources to obtain results",
    sec2Sub2Para2:
      "Figure 1 illustrates the basic flow of interaction between user, prompt, and LLM model.",

    figure1Caption:
      "<strong>Figure 1.</strong> Interaction flow in prompt engineering",

    // Section 3: Techniques
    sec3Title: "3. Core Techniques and Approaches in Prompt Engineering",
    sec3Para1:
      "There are multiple techniques for optimizing prompts, each with different applications and advantages <a href='#ref-12'>[12]</a>. In this section, we will examine the most important ones.",

    sec3Sub1Title: "3.1. Role and Context Setting",
    sec3Sub1Para1:
      "One of the most fundamental techniques is assigning a role and context to the AI model <a href='#ref-13'>[13]</a>. This is achieved through instructions as shown in Code 1.",
    code1Caption: "Code 1: Basic prompt for generating HTML form",
    sec3Sub1Para2:
      "This technique helps the model \"step into the role\" and generate more relevant responses <a href='#ref-14'>[14]</a>.",

    sec3Sub2Title: "3.2. Constraints, Formats, and Output Structures",
    sec3Sub2Para1:
      "Specifying exact format and constraints is critical for obtaining usable results <a href='#ref-15'>[15]</a>. See Code 2 for an example:",
    code2Caption: "Code 2: Advanced prompt with context and constraints",

    sec3Sub3Title: "3.3. Iterative Prompts and Refinement",
    sec3Sub3Para1:
      "The first prompt rarely gives perfect results. The iterative approach involves gradual refinement <a href='#ref-16'>[16]</a>:",
    ...
    sec3Sub4Para1:
      "Few-shot learning provides the model with examples of the desired format and style <a href='#ref-17'>[17]</a>. See Code 3:",
    code3Caption: "Code 3: Few-shot prompt with examples",

    sec3Sub5Title: "3.5. Chain-of-thought (CoT)",
    sec3Sub5Para1:
      "Chain-of-thought prompting encourages the model to \"think aloud\" and show the steps in its reasoning <a href='#ref-18'>[18]</a>. This is especially useful for complex tasks. See Code 4:",
    code4Caption: "Code 4: Chain-of-thought prompt for problem-solving",
    sec3Sub5Para2:
      "Important ethical note: When using CoT, we must be aware that the model simulates reasoning but does not \"think\" in a human way <a href='#ref-19'>[19]</a>. Results must always be validated.",

    sec3Sub6Title: "3.6. Self-consistency and Toolformer-style",
    sec3Sub6Para1:
      "Self-consistency involves generating multiple responses and choosing the most consistent one <a href='#ref-20'>[20]</a>. Toolformer-style interaction allows AI to \"call\" external tools <a href='#ref-21'>[21]</a>:",
    sec3Sub6Li1: "Code linters (ESLint, Prettier)",
    sec3Sub6Li2: "API validators (Postman, Swagger)",
    sec3Sub6Li3: "Browser DevTools",
    ...
    sec3Sub7Para1:
      "Systematic checking of AI-generated code is critically important <a href='#ref-22'>[22]</a>:",
    sec3Sub7Para2:
      "Table 1 shows the main categories of validation tools that should be used when working with AI-generated code.",
    ...
    sec4Para1:
      "ChatGPT and similar LLM models offer a wide range of applications in web development, from generating boilerplate code to assisting with architectural decisions <a href='#ref-23'>[23]</a>.",

    sec4Sub1Title: "4.1. Generating HTML/CSS/JS Templates",
    sec4Sub1Para1:
      "One of the most practical applications is automatic generation of code templates <a href='#ref-24'>[24]</a>. See Code 5:",
    code5Caption: "Code 5: Basic HTML5 template with semantic structure",

    sec4Sub2Title: "4.2. CSS Generation and Layout Systems",
    sec4Sub2Para1:
      "AI models can effectively generate modern CSS layouts <a href='#ref-25'>[25]</a>. Code 6 demonstrates a CSS Grid system:",
    code6Caption: "Code 6: CSS Grid layout generated by AI",

    sec4Sub3Title: "4.3. JavaScript and DOM Manipulation",
    sec4Sub3Para1:
      "ChatGPT can generate functional JavaScript code <a href='#ref-26'>[26]</a>. See Code 7:",
    code7Caption: "Code 7: JavaScript function for DOM manipulation",

    sec4Sub4Title: "4.4. Architecture, Documentation, and Tests",
    sec4Sub4Para1:
      "AI can help with architecture design and documentation generation <a href='#ref-27'>[27]</a>:",
    sec4Sub4Li1:
      "<strong>Architecture diagrams:</strong> Generating PlantUML, Mermaid diagrams",
    sec4Sub4Li2:
      "<strong>API documentation:</strong> OpenAPI/Swagger specifications",
    sec4Sub4Li3:
      "<strong>README files:</strong> Structured project documentation",
    sec4Sub4Li4: "<strong>Unit tests:</strong> Jest, Mocha, Pytest test cases",

    sec4Sub5Title: "4.5. i18n and Localization",
    sec4Sub5Para1:
      "ChatGPT can generate structures for internationalization <a href='#ref-28'>[28]</a>. Code 8 shows an example:",
    code8Caption: "Code 8: Example of i18n structure",

    sec4Sub6Title: "4.6. Best Practices for Pipeline Integration",
    sec4Sub6Para1:
      "Integrating AI into the development process requires discipline <a href='#ref-29'>[29]</a>:",
    ...
    figure2Caption:
      '<strong>Figure 2.</strong> Visualization of risks with "blind AI-coding"',
    sec4Sub7Para1:
      "Figure 2 illustrates the dangers of uncritically accepting AI-generated code. Main risks include <a href='#ref-30'>[30]</a>:",
    sec4Sub7Li1:
      "<strong>Errors:</strong> AI can generate syntactically correct but logically incorrect code",
    sec4Sub7Li2:
      "<strong>Sub-optimality:</strong> Models don't always generate the most efficient solution",
    sec4Sub7Li3:
      "<strong>Lack of standards:</strong> AI may not follow project conventions",
    sec4Sub7Li4:
      "<strong>Security:</strong> Vulnerabilities such as XSS, SQL injection, CSRF <a href='#ref-31'>[31]</a>",
    sec4Sub7Para2:
      "Especially dangerous is the phenomenon of \"vibe coding\" - when developers blindly copy AI-generated code without understanding how it works <a href='#ref-32'>[32]</a>.",

    sec4Sub8Title: "4.8. Ethics and Professional Responsibility",
    sec4Sub8Para1:
      "Using AI in development raises ethical questions <a href='#ref-33'>[33]</a>:",

    sec4Sub8Sub1Title: "Hallucinations",
    sec4Sub8Sub1Para1:
      "AI models can \"invent\" facts, APIs, or libraries that don't exist <a href='#ref-34'>[34]</a>. Examples:",
    ...
    sec4Sub8Sub2Para1:
      "Every AI recommendation must be validated against official documentation <a href='#ref-35'>[35]</a>:",
    ...
    sec4Sub8Sub3Para1:
      "Complex questions about intellectual property <a href='#ref-36'>[36]</a>:",
    ...
    sec4Sub9Para1:
      "ChatGPT can assist with digital marketing <a href='#ref-37'>[37]</a>:",
    sec4Sub9Li1:
      "<strong>Meta tags:</strong> Generating optimized meta description, keywords",
    sec4Sub9Li2: "<strong>Structured data:</strong> Schema.org JSON-LD markup",
    sec4Sub9Li3:
      "<strong>Content optimization:</strong> Heading hierarchy, keyword density",
    sec4Sub9Li4:
      "<strong>Alt texts:</strong> Accessibility and SEO image descriptions",
    code9Caption: "Code 9: Example of meta tags optimization",

    sec4Sub10Title: "4.10. Future of the Profession",
    sec4Sub10Para1:
      "AI fundamentally changes the web developer profession <a href='#ref-38'>[38]</a>:",
    ...
    sec5Para1:
      "This section presents concrete examples and case studies of using prompt engineering in real web projects.",

    sec5Sub1Title: "5.1. Demonstration of Different Prompt Types",
    sec5Sub1Para1:
      "We have already examined four types of prompts in previous sections:",
    ...
    sec5Sub3Case1Para:
      "A developer uses ChatGPT to generate a responsive navigation menu. AI generates clean code with accessibility features. After minor corrections, the code is production-ready <a href='#ref-42'>[42]</a>.",

    sec5Sub3Case2Title: "Case 2: Problematic Use",
    sec5Sub3Case2Para:
      "A junior developer asks AI to generate an authentication system. AI creates code without proper password hashing and with SQL injection vulnerabilities. Only after a security audit are the problems discovered <a href='#ref-43'>[43]</a>.",

    sec5Sub3Case3Title: "Case 3: Optimal Workflow",
    sec5Sub3Case3Para:
      "A senior team uses AI for boilerplate, but all results go through:",
    sec5Sub3Case3Li1: "Code review",
    sec5Sub3Case3Li2: "Automated testing",
    sec5Sub3Case3Li3: "Security scanning",
    sec5Sub3Case3Li4: "Performance profiling",
    sec5Sub3Case3Result:
      "Result: 35% faster development while maintaining quality <a href='#ref-44'>[44]</a>.",

    sec5Sub4Title: "5.4. How to Validate Results",
    sec5Sub4Para1:
      "Systematic approach to validation <a href='#ref-45'>[45]</a>:",
    ...
    sec6Para1:
      "Despite the advantages, using AI in web development carries significant risks that require attention and mitigation <a href='#ref-46'>[46]</a>.",

    sec6Sub1Title: "6.1. Ethical Challenges",

    sec6Sub1Sub1Title: "Transparency",
    sec6Sub1Sub1Para1:
      "Should it be declared that code is AI-generated? <a href='#ref-47'>[47]</a>",
    ...
    sec6Sub1Sub2Para1:
      "AI models can reproduce biases from training data <a href='#ref-48'>[48]</a>:",
    ...
    sec6Sub2Para1:
      "Statistics show that GPT-4 can generate invalid code in 12-18% of cases <a href='#ref-49'>[49]</a>. Typical problems:",
    ...
    sec6Sub3Para1:
      "AI-generated code can contain vulnerabilities <a href='#ref-50'>[50]</a>:",
    sec6Sub3Li1: "<strong>XSS:</strong> Insufficient input sanitization",
    sec6Sub3Li2:
      "<strong>SQL Injection:</strong> Direct insertion of user input",
    ...
    sec6Sub4Para1:
      "AI can generate invalid or fabricated citations <a href='#ref-51'>[51]</a>:",
    sec6Sub4Li1: "Non-existent articles",
    sec6Sub4Li2: "Wrong authors or dates",
    sec6Sub4Li3: "Invalid URLs",
    sec6Sub4Li4: "Confused sources",
    sec6Sub4Para2:
      "<strong>Solution:</strong> Always verify citations in the original source!",

    sec6Sub5Title: "6.5. Critical Checkpoints",
    sec6Sub5Para1:
      "Mandatory checks when using AI code <a href='#ref-52'>[52]</a>:",
    sec6Sub5Li1: "<strong>Pre-commit:</strong> Static analysis, linting",
    sec6Sub5Li2: "<strong>Code review:</strong> Human inspection",
    sec6Sub5Li3: "<strong>Testing:</strong> Unit, integration, e2e tests",
    sec6Sub5Li4: "<strong>Security scan:</strong> SAST/DAST tools",
    ...
    sec7Para1:
      "Prompt engineering represents a powerful tool for modern web development that can significantly accelerate and improve the software creation process <a href='#ref-53'>[53]</a>. However, the technology requires a responsible and critical approach.",

    sec7Sub1Title: "7.1. Author's Opinion",
    sec7Sub1Para1:
      "Based on the research in this paper, I believe that ChatGPT and prompt engineering <strong>should be used</strong>, but under the following conditions:",
    ...
    sec7Sub2Para1:
      "Recommendations for responsible use <a href='#ref-54'>[54]</a>:",
    ...
    sec7Sub3Para1:
      "In the next 5-10 years, I expect <a href='#ref-55'>[55]</a>:",
    sec7Sub3Li1:
      "<strong>Specialized models:</strong> AI trained specifically for web frameworks",
    sec7Sub3Li2:
      "<strong>IDE integration:</strong> Seamless AI assistance in dev tools",
    sec7Sub3Li3:
      "<strong>Automation:</strong> End-to-end code generation from design",
    sec7Sub3Li4:
      "<strong>New roles:</strong> AI prompt engineers, AI code reviewers",
    sec7Sub3Li5: "<strong>Standards:</strong> Industry guidelines for AI usage",

    sec7Sub4Title: "7.4. Final Words",
    sec7Sub4Para1:
      "Prompt engineering is not a magic solution, but a tool that requires skill, critical thinking, and professional responsibility. Successful developers will be those who combine fundamental knowledge with effective use of AI technologies <a href='#ref-56'>[56]</a>.",
    sec7Sub4Para2:
      "The future of web development lies in the symbiosis between human creativity and AI capabilities - not in replacing one with the other.",
    ...
    // Footer
    footerText:
      '&copy; 2025 Faculty of Mathematics and Informatics, Sofia University "St. Kliment Ohridski"',
    footerCourse:
      "Web Technologies Course, 25th Edition (Winter Semester 2025-2026)",
    footerAuthor:
      "Student FMI • Faculty number • <a href='https://github.com' target='_blank' rel='noopener noreferrer' class='github-link'><svg width='20' height='20' viewBox='0 0 16 16' fill='currentColor' style='vertical-align: middle; margin-right: 4px'><path d='M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z'/></svg>GitHub</a>",
  },
};
